...
RUNS_DIR = Path(os.environ.get("ROCK_SEG_3D_WEB_RUNS_DIR", Path.cwd() / "web_runs")).resolve()

from .core.geometric_analyzer import GeometricAnalyzer
from .core.mesh_processor import MeshProcessor
from .core.point_cloud_io import PointCloudFileHandler
from .core.RegionGrowing import RegionGrowingSegmentation
from .core.utils import filter_point_cloud
...
PROJECT_DEBUG_LOG_PATH = RUNS_DIR / "project_import_debug.log"
